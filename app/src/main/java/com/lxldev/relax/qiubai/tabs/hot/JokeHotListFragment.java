...
import com.lxldev.relax.qiubai.tabs.io.IndexIOService;

import java.util.List;

public class JokeHotListFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(contentView == null){
            ...
            contentView = inflater.inflate(R.layout.qiubai_fragment_index,container,false);
    ...
    private void initView(View view){
        ...
        springView = view.findViewById(R.id.qiubai_index_refreshView);

        recyclerView = view.findViewById(R.id.qiubai_index_recyclerview);
    ...
    private void loadData(boolean clean){
        ...
        jokeIOService.getHotJokeList(cur_page, new IOService.Callback<List<QiubaiJokeEntity>>() {
            @Override
            public void onSuccess(List<QiubaiJokeEntity> jokeEntities) {
